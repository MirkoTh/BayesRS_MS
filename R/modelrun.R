...
modelrun <- function(data, dv, dat.str, randvar.ia = NULL, nadapt = NULL, nburn = NULL, nsteps = NULL,
                    checkconv = NULL, mcmc.save.indiv = NULL, corstr = NULL, plot.post = NULL ,dic = NULL){
  ...
  source("modeltext.R")
  parameters <- c(modeltext(dat.str, randvar.ia, corstr))
